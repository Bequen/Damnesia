...
MyProject2-Linux-Debug:
	 $(PROJECTBUILD) MyProject2 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2-Linux-DebugGame:
	 $(PROJECTBUILD) MyProject2 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2-Linux-Shipping:
	 $(PROJECTBUILD) MyProject2 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2-Linux-Test:
	 $(PROJECTBUILD) MyProject2 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2:
	 $(PROJECTBUILD) MyProject2 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2Editor-Linux-Debug:
	 $(PROJECTBUILD) MyProject2Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2Editor-Linux-DebugGame:
	 $(PROJECTBUILD) MyProject2Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2Editor-Linux-Shipping:
	 $(PROJECTBUILD) MyProject2Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2Editor-Linux-Test:
	 $(PROJECTBUILD) MyProject2Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyProject2Editor:
	 $(PROJECTBUILD) MyProject2Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
