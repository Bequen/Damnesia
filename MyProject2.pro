...
MyProject2RootPath=/home/martin/Projects/UnrealProjects/MyProject2

gameProjectFile=/home/martin/Projects/UnrealProjects/MyProject2/MyProject2.uproject
...
include(MyProject2Source.pri)
include(MyProject2Header.pri)
include(MyProject2Config.pri)
include(MyProject2Includes.pri)
include(MyProject2Defines.pri)

MyProject2-Linux-Debug.commands = $$build MyProject2 Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyProject2-Linux-DebugGame.commands = $$build MyProject2 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyProject2-Linux-Shipping.commands = $$build MyProject2 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyProject2-Linux-Test.commands = $$build MyProject2 Linux Test  -project="\"$$gameProjectFile\"" $$args
MyProject2.commands = $$build MyProject2 Linux Development  -project="\"$$gameProjectFile\"" $$args

MyProject2Editor-Linux-Debug.commands = $$build MyProject2Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyProject2Editor-Linux-DebugGame.commands = $$build MyProject2Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyProject2Editor-Linux-Shipping.commands = $$build MyProject2Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyProject2Editor-Linux-Test.commands = $$build MyProject2Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
MyProject2Editor.commands = $$build MyProject2Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	MyProject2-Linux-Debug \
	MyProject2-Linux-DebugGame \
	MyProject2-Linux-Shipping \
	MyProject2-Linux-Test \
	MyProject2 \
	MyProject2Editor-Linux-Debug \
	MyProject2Editor-Linux-DebugGame \
	MyProject2Editor-Linux-Shipping \
	MyProject2Editor-Linux-Test \
	MyProject2Editor \
